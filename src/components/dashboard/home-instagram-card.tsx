...
export function HomeInstagramCard() {
  ...
  return (
    <div className="flex flex-col items-center gap-3 rounded-[1.25rem] border border-[#242629] bg-[#131518] px-5 py-6 text-center">
      ...
      <div>
        ...
        <p className="mx-auto mt-1 max-w-xs text-xs text-[#a2a5a8]">{t("instagram.desc")}</p>
      </div>
      <a
        href={`https://instagram.com/${INSTAGRAM_HANDLE}`}
        target="_blank"
        rel="noreferrer"
        className="inline-flex items-center gap-1 rounded-xl bg-white px-4 py-2.5 text-xs font-bold text-[#08090a]"
      >
        {t("instagram.cta")}
      </a>
    </div>

...
const en: Dict = {
  ...
  "dashboard.subtitle": "Discover exciting flea markets and book your perfect stall.",
...
const hi: Dict = {
  ...
  "dashboard.subtitle": "रोमांचक फ्ली मार्केट खोजें और अपना सही स्टॉल बुक करें।",
...
const kn: Dict = {
  ...
  "dashboard.subtitle": "ರೋಮಾಂಚಕಾರಿ ಫ್ಲೀ ಮಾರುಕಟ್ಟೆಗಳನ್ನು ಕಂಡುಹಿಡಿಯಿರಿ ಮತ್ತು ನಿಮ್ಮ ಸೂಕ್ತ ಸ್ಟಾಲ್ ಕಾಯ್ದಿರಿಸಿ.",
